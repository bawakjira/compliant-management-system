 ...
 * @author ADMIN
 */
public class Admin_Administrative_Complaints_Controller extends HttpServlet {
    ...
    throws ServletException,IOException
{
  ...
  String sql = "select * from student_complaints where complaintsType = 'administrative '" ;
